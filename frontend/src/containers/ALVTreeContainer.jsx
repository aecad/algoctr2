...
import "./ALVTreeContainer.css";
// import "bootstrap/dist/css/bootstrap.min.css";
import BinarySearchTree from './classes/BinarySearchTree';
import BinarySearchTreeNode from "../components/AlgorithmPage/BinarySearchTreeNode";

class ALVTreeContainer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            insertValue: "",
...
export default ALVTreeContainer;
